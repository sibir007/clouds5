...
public class EditCloudWindowController {
    ...
    private int oldCLoudIndex;
    private Cloud oldCloud;
    ...
    @FXML
    private boolean editCloud(ActionEvent actionEvent) {
        if (validCLoudAddress) {
            editCLoud(oldCLoudIndex ,host.getText(), getPort());
            hideWindow();
            return true;
        }
        cloudValidationLabel.setText(CLOUD_VALIDATION_LABEL_ERROR_MESSAGE);
    ...
    public void editCLoud(int oldCLoudIndex, String newCloudHost, int newCloudPort){
        clientCoordinator.editCLoud(oldCLoudIndex, newCloudHost, newCloudPort);
    }
    ...
    public void cancelEditCloud(ActionEvent actionEvent) {
        hideWindow();
    }
    ...
    private void clearAllValue() {
        ...
        oldCloudLabel.setText(EMPTY_TEXT_FOR_LABEL);
        cloudValidationLabel.setText(EMPTY_TEXT_FOR_LABEL);
        portValidationLabel.setText(EMPTY_TEXT_FOR_LABEL);
        hostValidationLabel.setText(EMPTY_TEXT_FOR_LABEL);
    }
    ...
    public void setOldCloud(int cloudIndex) {
        this.oldCLoudIndex = cloudIndex;
        this.oldCloud = model.getCloud(cloudIndex);
        oldCloudLabel.setText("old cloud credentials: " + oldCloud.getHost() + ":" + oldCloud.getPort());
    }
}
