...
public class CloudBeenImpl implements Cloud {
    ...
    private SimpleObjectProperty<CloudAvailabilityStatus> cloudAvailabilityStatusSimpleObjectProperty = new SimpleObjectProperty<>(this, "cloudAvailabilityStatus", CloudAvailabilityStatus.FILED);
    ...
    public void setCloudAvailabilityStatus(CloudAvailabilityStatus status) {
        cloudAvailabilityStatusSimpleObjectProperty.set(status);
    }

    @Override
    public CloudAvailabilityStatus getCloudAvailabilityStatus() {
        return cloudAvailabilityStatusSimpleObjectProperty.get();
    }
