...
public abstract class AbstractAuthorisedTransaction extends AbstractSimpleTransaction implements AutorisedTransaction {
...
private final String password;
    ...
    protected AbstractAuthorisedTransaction(String id,
                                            String rootId,
                                            String parentId,
                                            Direction direction,
                                            Status status,
