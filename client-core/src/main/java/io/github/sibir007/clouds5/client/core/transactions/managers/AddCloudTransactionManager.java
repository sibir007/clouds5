...
public class AddCloudTransactionManager {
    ...
    public synchronized void processTransaction(Cloud cloud) {
        ...
        AddCloudTransaction addCloudTransaction = transactionEntity.createAddCloudTransaction(cloud);
        TransactionResponse response = cloudsService.processAddCloudTransaction(addCloudTransaction);
